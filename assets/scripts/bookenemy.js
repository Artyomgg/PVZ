const bookContent = [
  ...
  },
  {
    ...
    content: "Обычный рыцарь — базовый враг с 6 единицами здоровья и скоростью передвижения 20 единиц в секунду. Появляется с вероятностью 50%.",
    image: "../assets/img/KNIGHTS/chel.gif",
  },
  {
    type: "page",
    title: "Бронированный рыцарь 🛡️",
    content: "Бронированный рыцарь обладает повышенной защитой с 9 единицами здоровья и скоростью 25 единиц в секунду. Появляется с вероятностью 25%.",
    image: "../assets/img/KNIGHTS/chel2.gif",
  },
  {
    type: "page",
    title: "Рыцарь-охотник 🏹",
    content: "Рыцарь-охотник имеет 10 единиц здоровья и скорость 12 единицы в секунду. Появляется с вероятностью 25%. ",
    image: "../assets/img/KNIGHTS/chel3.gif",
  },
  {
    type: "page",
    title: "Золотой рыцарь ✨",
    content: "Золотой рыцарь — редкий и мощный враг с 10 единицами здоровья и скоростью 19 единиц в секунду. Появляется с вероятностью 15%.",
