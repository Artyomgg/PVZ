const bookContent = [
  ...
  },
  {
    ...
    content: "Огненный дракон выпускает огненные шары, наносящие 10 урона каждые 1.5 секунды. Стоимость: 50 огоньков. Особенность: периодически создает огненные капли (каждые 9 секунд), которые можно собрать для получения 25 солнц.",
    image: "../assets/img/Dragons/красно-белый.png",
  },
  {
    type: "page",
    title: "Ледяной дракон ❄️",
    content: "Ледяной дракон стреляет ледяными шарами, наносящими 15 урона каждые 2 секунды. Стоимость: 75 огоньков. Ледяные снаряды замедляют зомби при попадании.",
    image: "../assets/img/Dragons/синий-большой.png",
  },
  {
    type: "page",
    title: "Ядовитый дракон 🐍",
    content: "Ядовитый дракон выпускает вращающиеся ядовитые снаряды, наносящие 10 урона каждые 2.5 секунды. Стоимость: 100 огоньков. Яд наносит урон нескольким зомби в небольшой области.",
    image: "../assets/img/Dragons/фиолетово-синий.png",
  },
  {
    type: "page",
    title: "Молниевый дракон ⚡",
    content: "Молниевый дракон атакует молниями, наносящими 20 урона каждые 2 секунды в двух клетках впереди. Стоимость: 150 огоньков. Молнии поражают всех зомби в области клетки.",
    image: "../assets/img/Dragons/маленький-красный.png",
  },
  {
    type: "page",
    title: "Взрывной дракон 💥",
    content: "Взрывной дракон создает мощный взрыв через 3 секунды после размещения, наносящий 30 урона всем зомби в радиусе 3 клеток. Стоимость: 100 огоньков. Одноразовый эффект, после взрыва дракон исчезает.",
    image: "../assets/img/Dragons/красный-большой.png",
  },
  {
    type: "page",
    title: "Смертельный дракон 💀",
    content: "Смертельный дракон атакует раз в 6 секунд, если противник находится дальше 3-x клеток. Мгновенно убивает почти любого врага. Стоимость: 250 огоньков.",
